...
define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . tep_href_link(FILENAME_DEFAULT) . '">' . STORE_NAME . '</a><br />Powered by <a href="http://www.wponlinestore.com" target="_blank">WP Online Store</a> / <a href="http://www.oscommerce.com" target="_blank">OSCommerce</a>');
