...
<tr>
  <td>
    <table border="0" align="center">
      <tr>
        <td align="left" class="main"><?php echo tep_draw_button(IMAGE_BUTTON_PREVIOUS_PRODUCT, 'circle-arrow-w', tep_href_link(FILENAME_PRODUCT_INFO, "$fPath&products_id=$previous"), null, null); ?>&nbsp;</td>
        <td align="center" class="main" valign="middle"><?php echo (PREV_NEXT_PRODUCT) . '&nbsp;<strong><u>' . ($position+1 . "</u></strong> " . PREV_NEXT_OF . " <strong>" . $counter) . '</strong> ' ; ?>&nbsp;&nbsp;</td>
        <td align="left" class="main"><?php echo tep_draw_button(IMAGE_BUTTON_NEXT_PRODUCT, 'circle-arrow-e', tep_href_link(FILENAME_PRODUCT_INFO, "$fPath&products_id=$next_item"), null, null); ?>&nbsp;</td>
      </tr>
    </table>
  </td>
</tr>
