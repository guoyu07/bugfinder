...
*/
  ...
  chdir('../../../../');
  require(WP_PLUGIN_DIR . '/'.WPOLS_PLUGINS_DIR.'/admin/includes/application_top.php');
  require(WP_PLUGIN_DIR . '/'.WPOLS_PLUGINS_DIR.'/includes/languages/' . $language . '/modules/payment/moneybookers.php');
  require(WP_PLUGIN_DIR . '/'.WPOLS_PLUGINS_DIR.'/includes/modules/payment/moneybookers.php');
  ...
  require(WP_PLUGIN_DIR . '/'.WPOLS_PLUGINS_DIR.'/admin/'.DIR_WS_INCLUDES . 'template_top.php');
?>
...
<?php
  require(WP_PLUGIN_DIR . '/'.WPOLS_PLUGINS_DIR.'/admin/'.DIR_WS_INCLUDES . 'template_bottom.php');
  require(WP_PLUGIN_DIR . '/'.WPOLS_PLUGINS_DIR.'/admin/'.DIR_WS_INCLUDES . 'application_bottom.php');
?>
