...
*/
 ...
 /* $cl_box_groups[] = array(
  ...
  $information_groups_query = tep_db_query("SELECT information_group_id AS igID, information_group_title AS igTitle FROM " . TABLE_INFORMATION_GROUP . " WHERE visible='1' ORDER BY sort_order Limit 1");
