...
//		header('Content-type: application/vnd.ms-excel; charset="utf-8"');
        ...
        fclose($fp);
        $msgsuccess =  "<b>You can get your file in the Tools/File Manager here: " . EP_TEMP_DIRECTORY . "EP" . $EXPORT_TIME . ((EP_EXCEL_SAFE_OUTPUT == true)?".csv":".txt")."</b>";
        //die();
    }
} 
...
<table width="100%">
  <tr>
    <td class="pageHeading">Easy Populate</td>
  </tr>
</table>
...
<br />
<br />
<span class="success" style="color:#009900; padding:5px;"><?=$msgsuccess?></span>
<br />
<br />
<? } ?>
...
?>
      ...
      <table width="<?php if (EP_SHOW_EP_SETTINGS == true) { echo '95'; } else { echo '75'; } ?>%" cellpadding="5" cellspacing="0" style="border-collapse:collapse;">
        <tr>
          <td width="75%" style="border-style:solid; border-width:thin; border-color:#CCCCCC;"><p>Easy Populate lets you quickly populate and update thousands of products in many categories.<br />
          It is a useful tool for moving products from one shop to another, for backing up your products, or for adding multiple items quickly and easily.<br />
          Download a CSV file of your current store as an example of how the document should be laid out.</p>
            <p><span style="font-size:10px;background-color:#FFFFCC; width:100%;">&nbsp;Please <a href="admin.php?page=WP_online_store&submenu=backup<?php if (defined('SID') && tep_not_null(SID)) { echo '?'.tep_session_name().'='.tep_session_id(); } ?>" style="font-size:10px;background-color:#FFFFCC;text-decoration:underline;">backup your database</a> before performing any Easy Populate operations!&nbsp; &nbsp;</span><br />
            </p>
            <form enctype="multipart/form-data" action="admin.php?page=WP_online_store&submenu=easypopulate&split=0<?php if (defined('SID') && tep_not_null(SID)) { echo '&'.tep_session_name().'='.tep_session_id(); } ?>" method="post"><?php if (defined('SID') && tep_not_null(SID)) { echo tep_draw_hidden_field(tep_session_name(), tep_session_id()); } ?>
          <p style="margin-top: 18px; margin-bottom: 8px;"><b>Upload and Import Easy Populate File</b></p>
           ...
           <form enctype="multipart/form-data" action="admin.php?page=WP_online_store&submenu=easypopulate&split=1<?php if (defined('SID') && tep_not_null(SID)) { echo '&'.tep_session_name().'='.tep_session_id(); } ?>" method="post"><?php if (defined('SID') && tep_not_null(SID)) { echo tep_draw_hidden_field(tep_session_name(), tep_session_id()); } ?>
           ...
           <form enctype="multipart/form-data" action="admin.php?page=WP_online_store&submenu=easypopulate&<?php if (defined('SID') && tep_not_null(SID)) { echo ''.tep_session_name().'='.tep_session_id(); } ?>" method="post"><?php if (defined('SID') && tep_not_null(SID)) { echo tep_draw_hidden_field(tep_session_name(), tep_session_id()); } ?>
        ...
        <p style="margin-top: 0px;"><!-- Download file links -  Add your custom fields here -->
          ...
          <input type="hidden"  name="page" value="WP_online_store" />
          <input type="hidden"  name="submenu" value="easypopulate" />
        ...
        <p style="margin-top: 8px;"><b>Create and download a CSV template for adding new products to. Or create a backup file of your current products.</b><br />
        </p>
        <p> <!--Download file links -  Add your custom fields here //-->
          <a href="admin.php?page=WP_online_store&submenu=easypopulate&download=stream&dltype=full<?php if (defined('SID') && tep_not_null(SID)) { echo '&'.tep_session_name().'='.tep_session_id(); } ?>">Download <b>Complete<?php if (EP_SPPC_SUPPORT == true) { echo ' w/SPPC'; } ?></b> <?php echo ((EP_EXCEL_SAFE_OUTPUT == true)?".csv":".txt"); ?> file to edit</a><br />
<?php if (EP_EXTRA_FIELDS_SUPPORT == true) { ?>
          <a href="admin.php?page=WP_online_store&submenu=easypopulate&download=stream&dltype=extra_fields<?php if (defined('SID') && tep_not_null(SID)) { echo '&'.tep_session_name().'='.tep_session_id(); } ?>">Download <b>Extra Fields</b> <?php echo ((EP_EXCEL_SAFE_OUTPUT == true)?".csv":".txt"); ?> file to edit</a><br />
<?php } ?>
          <a href="admin.php?page=WP_online_store&submenu=easypopulate&download=stream&dltype=priceqty<?php if (defined('SID') && tep_not_null(SID)) { echo '&'.tep_session_name().'='.tep_session_id(); } ?>">Download <b>Model/Price/Qty<?php if (EP_SPPC_SUPPORT == true) { echo ' w/SPPC'; } ?></b> <?php echo ((EP_EXCEL_SAFE_OUTPUT == true)?".csv":".txt"); ?> file to edit</a><br />
          <a href="admin.php?page=WP_online_store&submenu=easypopulate&download=stream&dltype=category<?php if (defined('SID') && tep_not_null(SID)) { echo '&'.tep_session_name().'='.tep_session_id(); } ?>">Download <b>Model/Category</b> <?php echo ((EP_EXCEL_SAFE_OUTPUT == true)?".csv":".txt"); ?> file to edit</a><br />
					<!-- Products Images Support //-->
					<a href="admin.php?page=WP_online_store&submenu=easypopulate&download=stream&dltype=prodimage<?php if (defined('SID') && tep_not_null(SID)) { echo '&'.tep_session_name().'='.tep_session_id(); } ?>">Download <b>Model/Images<?php if (EP_SPPC_SUPPORT == true) { echo ' w/SPPC'; } ?></b> <?php echo ((EP_EXCEL_SAFE_OUTPUT == true)?".csv":".txt"); ?> file to edit</a><br /><!--
					 Products Images Support end //-->
<?php /*?>          <a href="admin.php?page=WP_online_store&submenu=easypopulate&download=stream&dltype=froogle<?php if (defined('SID') && tep_not_null(SID)) { echo '&'.tep_session_name().'='.tep_session_id(); } ?>">Download <b>Froogle</b> <?php echo ((EP_EXCEL_SAFE_OUTPUT == true)?".csv":".txt"); ?> file</a><br /><?php */?>
         <!-- VJ product attributes begin //-->
          <?php if (EP_PRODUCTS_WITH_ATTRIBUTES == true) { ?>
          <a href="admin.php?page=WP_online_store&submenu=easypopulate&download=stream&dltype=attrib<?php if (defined('SID') && tep_not_null(SID)) { echo '&'.tep_session_name().'='.tep_session_id(); } ?>">Download <b>Model/Attributes</b> <?php echo ((EP_EXCEL_SAFE_OUTPUT == true)?".csv":".txt"); ?> file</a><br />
          <?php } ?>
          <!-- VJ product attributes end //-->
          <!-- Master Products support begin //-->
          <?php if (MASTER_PRODUCTS_SUPPORT == true) { ?>
          <a href="admin.php?page=WP_online_store&submenu=easypopulate&download=stream&dltype=masterstatus<?php if (defined('SID') && tep_not_null(SID)) { echo '&'.tep_session_name().'='.tep_session_id(); } ?>">Download <b>Model/Master/Status<?php if (EP_SPPC_SUPPORT == true) { echo ' w/SPPC'; } ?></b> <?php echo ((EP_EXCEL_SAFE_OUTPUT == true)?".csv":".txt"); ?> file to edit</a><br />
          <?php } ?>
		...
		<td width="50%" valign="top" bgcolor="#EEEEEE">
        <p style="margin-top: 8px;"><b>Create and save to &quot;temp&quot; directory (see right column) a CSV template for adding new products to. Or create a backup file of your current products.</b></p>
        <p>
          <a href="admin.php?page=WP_online_store&submenu=easypopulate&download=tempfile&dltype=full<?php if (defined('SID') && tep_not_null(SID)) { echo '&'.tep_session_name().'='.tep_session_id(); } ?>">Create <b>Complete</b> <?php echo ((EP_EXCEL_SAFE_OUTPUT == true)?".csv":".txt"); ?> file in temp dir</a><br />
          <a href="admin.php?page=WP_online_store&submenu=easypopulate&download=tempfile&dltype=priceqty<?php if (defined('SID') && tep_not_null(SID)) { echo '&'.tep_session_name().'='.tep_session_id(); } ?>">Create <b>Model/Price/Qty</b> <?php echo ((EP_EXCEL_SAFE_OUTPUT == true)?".csv":".txt"); ?> file in temp dir</a><br />
          <a href="admin.php?page=WP_online_store&submenu=easypopulate&download=tempfile&dltype=category<?php if (defined('SID') && tep_not_null(SID)) { echo '&'.tep_session_name().'='.tep_session_id(); } ?>">Create <b>Model/Category</b> <?php echo ((EP_EXCEL_SAFE_OUTPUT == true)?".csv":".txt"); ?> file in temp dir</a><br />
					<!-- Products Images Support //-->
					<a href="admin.php?page=WP_online_store&submenu=easypopulate&download=tempfile&dltype=prodimage<?php if (defined('SID') && tep_not_null(SID)) { echo '&'.tep_session_name().'='.tep_session_id(); } ?>">Create <b>Model/Images<?php echo ((EP_EXCEL_SAFE_OUTPUT == true)?".csv":".txt"); ?> file in temp dir</a><br />
					<!-- Products Images Support end //-->
<?php /*?>          <a href="admin.php?page=WP_online_store&submenu=easypopulate&download=tempfile&dltype=froogle<?php if (defined('SID') && tep_not_null(SID)) { echo '&'.tep_session_name().'='.tep_session_id(); } ?>">Create <b>Froogle</b> <?php echo ((EP_EXCEL_SAFE_OUTPUT == true)?".csv":".txt"); ?> file in temp dir</a><br /><?php */?>
          <!-- VJ product attributes begin //-->
          <?php if (EP_PRODUCTS_WITH_ATTRIBUTES == true) { ?>
          <a href="admin.php?page=WP_online_store&submenu=easypopulate&download=tempfile&dltype=attrib<?php if (defined('SID') && tep_not_null(SID)) { echo '&'.tep_session_name().'='.tep_session_id(); } ?>">Create <b>Model/Attributes</b> <?php echo ((EP_EXCEL_SAFE_OUTPUT == true)?".csv":".txt"); ?> file in temp dir</a><br />
          <?php } ?>
          <!-- VJ product attributes end //-->
          <!-- Master Products support begin //-->
          <?php if (MASTER_PRODUCTS_SUPPORT == true) { ?>
          <a href="admin.php?page=WP_online_store&submenu=easypopulate&download=tempfile&dltype=masterstatus<?php if (defined('SID') && tep_not_null(SID)) { echo '&'.tep_session_name().'='.tep_session_id(); } ?>">Create <b>Model/Master/Status</b> <?php echo ((EP_EXCEL_SAFE_OUTPUT == true)?".csv":".txt"); ?> file in temp dir</a><br />
          <?php } ?>
          <!-- Master Products support end //-->
        </p><br />
        </td></tr></table>
          ...
          <p style="margin-top: 8px;"><a href="../wp-content/plugins/wp-online-store/admin/EPDocumentation/index.html" target="_blank" style="font-size:16px; text-decoration:underline;">EP Documentation</a></p>
          ...
          <table border="0" cellpadding="0" cellspacing="0"><tr><td class="smallText">
             ...
             <br />
             <strong>Temp Directory:</strong><br />
            ...
            <?php /*?> SEF Froogle URLS: <?php echo (EP_FROOGLE_SEF_URLS?'true':'false'); ?><br /><?php */?>
             <br />
