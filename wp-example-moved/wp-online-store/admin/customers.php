        ...
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          ...
          <tr><?php echo tep_draw_form('search', FILENAME_CUSTOMERS, '', 'get'); ?>
            ...
            <td class="pageHeading" align="right"><?php echo tep_draw_separator('pixel_trans.gif', 1, HEADING_IMAGE_HEIGHT); ?></td>
               ...
               <td class="smallText" align="right"><?php echo HEADING_TITLE_SEARCH . ' ' . tep_draw_input_field('search').tep_draw_hidden_field('page').tep_draw_hidden_field('submenu'); ?></td>
...
<?php
    ...
    if (isset($_REQUEST['search']) && tep_not_null($_REQUEST['search'])) {

      $keywords = tep_db_input(tep_db_prepare_input($_REQUEST['search']));
    ...
    while ($customers = tep_db_fetch_array($customers_query)) {
      ...
      if (isset($cInfo) && is_object($cInfo) && ($customers['customers_id'] == $cInfo->customers_id)) {
        ...
        echo '          <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href=\'' . tep_href_link(FILENAME_CUSTOMERS, tep_get_all_get_params(array('cID','search')) . 'cID=' . $customers['customers_id'].'&search=' . $_REQUEST['search']) . '\'">' . "\n";
...
?>
                ...
                <td class="dataTableContent" align="right"><?php if (isset($cInfo) && is_object($cInfo) && ($customers['customers_id'] == $cInfo->customers_id)) { echo tep_image(DIR_WS_IMAGES . 'icon_arrow_right.gif', ''); } else { echo '<a href="' . tep_href_link(FILENAME_CUSTOMERS, tep_get_all_get_params(array('cID','page','submenu','search')) . 'cID=' . $customers['customers_id'].'&search='.$_REQUEST['search']) . '">' . tep_image(DIR_WS_IMAGES . 'icon_info.gif', IMAGE_ICON_INFO) . '</a>'; } ?>&nbsp;</td>
              ...
              <tr>
                ...
                <td colspan="4"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  ...
                  <tr>
                    ...
                    <td class="smallText" align="right"><?php echo $customers_split->display_links($customers_query_numrows, MAX_DISPLAY_SEARCH_RESULTS, MAX_DISPLAY_PAGE_LINKS, $HTTP_GET_VARS['pages'], tep_get_all_get_params(array('pages', 'info', 'x', 'y', 'cID')),'pages'); ?></td>
