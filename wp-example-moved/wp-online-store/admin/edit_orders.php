...
*/
  ...
  global $wpdb;
  if( $wpdb->get_var("SHOW TABLES LIKE 'eorder_text'") != "eorder_text" )  {
  
  $structure_eorder_text="CREATE TABLE `eorder_text` (
  ...
  KEY `status_id` (`eorder_text_id`)

) ;
  ";
			
			
			$wpdb->query($structure_eorder_text);
  
  
  	$wpdb->query("INSERT INTO `eorder_text` VALUES (1, 1, '<-STORE_NAME->\r\n------------------------------------------------------\r\nOrder Number: <-insert_id->\r\n\r\n\r\n\r\nDetailed Invoice: <-INVOICE_URL->\r\n\r\nDate Ordered: <-DATE_ORDERED->\r\n\r\nProducts\r\n------------------------------------------------------\r\n<-Item_List->\r\r\n------------------------------------------------------\r\n<-List_Total->\r\n\r\r\n------------------------------------------------------\r\n<-BILL_Adress->\r\n\r\r\n------------------------------------------------------\r\n<-DELIVERY_Adress->\r\n\r\r\n------------------------------------------------------\r\nPayment Method\r\n------------------------------------------------------\r\n<-Payment_Modul_Text->\r\n\r\n<-Payment_Modul_Text_Footer->')");

	$wpdb->query("INSERT INTO `eorder_text` VALUES (1, 2, \" <table id='AutoNumber3' style='border-collapse: collapse;' border='0' cellpadding='10' cellspacing='0' width='100%'> <tbody> <tr> <td width='100%'><font face='Arial'><strong>&lt;-SHOP_NAME-&gt;<br><br>
</strong></font>  <hr style='width: 281px; height: 1px;' align='left' color='#000000'>  <p><font face='Arial'><strong><font size='2'>&lt;-insert_id-&gt;</font><br></strong></font></p> 
<p><font face='Arial'><strong><font size='1'>&lt;-INVOICE_URL-&gt;</font></strong></font></p> 
<p><font face='Arial' size='2'><strong>&lt;-DATE_ORDERED-&gt;</strong></font></p> 
<p><strong><font color='#ff0000' face='Arial'><br>
</font></strong></p>
<table id='AutoNumber2' style='border-collapse: collapse;' border='0' cellpadding='0' cellspacing='0'> 
<tbody> <tr> <td style='border-width: 1px; border-bottom: 1px solid;' width='100%'><font face='Arial'>&lt;-Item_List-&gt;</font></td></tr> <tr> <td width='100%'><b><font face='Arial'>&lt;-List_Total-&gt;</font></b></td></tr></tbody></table> <p>&nbsp;</p></td></tr></tbody></table> <table id='AutoNumber1' style='border-collapse: collapse;' border='0' cellpadding='10' cellspacing='0'> <tbody> <tr> <td valign='top' width='50%'><font face='Arial' size='2'><b><font color='#ff0000'>Billing Address</font><font color='#ff0000'>:<br><br><br></font></b>&lt;-BILL_Adress-&gt;</font></td> <td valign='top' width='50%'><font color='#ff0000' face='Arial'><b><font size='2'>Shipping Address:<br><br><br></font></b></font><font face='Arial' size='2'>&lt;-DELIVERY_Adress-&gt;</font></td></tr></tbody></table> <table id='AutoNumber4' style='border-collapse: collapse;' border='0' cellpadding='10' cellspacing='0' width='100%'> <tbody> <tr> <td width='100%'><font face='Arial' size='2'><b><font color='#ff0000'><br><br></font></b>&lt;-Payment_Modul_Text-&gt;</font>  <p><font face='Arial' size='2'>&lt;-Payment_Modul_Text_Footer-&gt;</font></p></td></tr></tbody></table> \" )");
...
//		}
      ...
      $text = $werte["eorder_text_one"];
			...
			$text = preg_replace('/<-INVOICE_URL->/', tep_mail_catalog_href_link(FILENAME_ACCOUNT_HISTORY_INFO, 'order_id=' . $oID, 'SSL'), $text);
      ...
      <div id="header">
          ...
          <ul>
			 ...
			 <?php if (ORDER_EDITOR_USE_AJAX == 'true') { ?>
              ...
              document.write("<li><a href=\"javascript:newOrderEmail()\"><img src=\"../wp-content/plugins/wp-online-store/admin/includes/languages/<?php echo $language; ?>/images/buttons/button_new_order_email.gif\" border=\"0\" alt=\"<?php echo IMAGE_NEW_ORDER_EMAIL; ?>\" title=\"<?php echo IMAGE_NEW_ORDER_EMAIL; ?>\" ></a></li>");
	           //--></script>
			   <?php } ?>
            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td valign="top" width="100%">
				  <br>
				    <div>
					  <a href="<?php echo tep_href_link(FILENAME_ORDERS_EDIT_ADD_PRODUCT, 'oID=' . $_GET['oID'] . '&step=1'); ?>" target="addProducts" onClick="openWindow('<?php echo tep_href_link(FILENAME_ORDERS_EDIT_ADD_PRODUCT, 'oID=' . $_GET['oID'] . '&step=1'); ?>','addProducts');return false"><?php echo tep_image_button('../../../../includes/languages/english/images/buttons/button_add_article.gif', TEXT_ADD_NEW_PRODUCT); ?></a><input type="hidden" name="subaction" value="">
				    </div>
				  <br>
			    </td>
  ...
  for ($i=0; $i<sizeof($order->totals); $i++) {
    ...
    if ( ($order->totals[$i]['class'] == 'ot_total') || ($order->totals[$i]['class'] == 'ot_subtotal') || ($order->totals[$i]['class'] == 'ot_tax') || ($order->totals[$i]['class'] == 'ot_loworderfee') ) {
      ...
      if ($order->totals[$i]['class'] != 'ot_total') {
		...
		<script language="JavaScript" type="text/javascript">
		<!--
		document.write("<span id=\"update_totals['.$i.']\"><a href=\"javascript:setCustomOTVisibility(\'update_totals['.($i+1).']\', \'visible\', \'update_totals['.$i.']\');\"><img src=\"../wp-content/plugins/wp-online-store/admin/order_editor/images/plus.gif\" border=\"0\" alt=\"' . IMAGE_ADD_NEW_OT . '\" title=\"' . IMAGE_ADD_NEW_OT . '\"></a></span>");
		//-->
        </script></td>' . "\n";
      } else {
