<?php
/*
  $Id: extra_values.php ver 2.03 by Kevin L. Shelton 2010-10-29
...
<table border="0" width="100%" cellspacing="2" cellpadding="2">
  <tr>
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
      ...
      echo tep_draw_button(IMAGE_SAVE, 'disk', null, 'primary') . tep_draw_button(IMAGE_CANCEL, 'close', tep_href_link(FILENAME_EXTRA_VALUES, 'list_id=' . $list_id . "&vid=" . $vid)) . "\n"
      ?>
      </form></td></tr>
...
<?php // build information box contents
  ...
  if (!empty($selected)) {
    ...
    $contents[] = array('align' => 'center', 'text' => tep_draw_button(IMAGE_EDIT, 'document', tep_href_link(FILENAME_EXTRA_VALUES, 'vid=' . $vid . '&action=edit&list_id=' . $list_id)) . tep_draw_button(IMAGE_DELETE, 'trash', tep_href_link(FILENAME_EXTRA_VALUES, 'vid=' . $vid . '&action=delete&list_id=' . $list_id)));
    if (!$field_info['epf_multi_select'])
